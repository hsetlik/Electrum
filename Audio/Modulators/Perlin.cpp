 ...
 *
 *  Using a real hash function would be better to improve the "repeatability of 256" of the above
 * permutation table, but fast integer Hash functions uses more time and have bad random properties.
 *
