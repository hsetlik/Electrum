...
namespace GUIUtil {
inline void strokeArc(Graphics &g, float x, float y, float w, float h,
                      float startRads, float endRads, float lineWeight)
{
  Path path;
...
inline void strokeArc(Graphics &g, Rectangle<float> area, float startRads,
                      float endRads, float lineWeight)
{
  strokeArc(g, area.getX(), area.getY(), area.getWidth(), area.getHeight(),
            startRads, endRads, lineWeight);
}

inline AffineTransform getTransformForSlider(Rectangle<float> &area,
                                             float startRads, float endRads,
                                             float sliderPos)
{
