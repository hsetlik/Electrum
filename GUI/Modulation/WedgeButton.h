...
public:
    ...
    static Path getWedgePath(float x0, float y0, float startRads, float endRads, float r1, float r2, float offsetX=0.0f, float offsetY=0.0f);
protected:
    float a1, a2, r1, r2;
...
public:
    ...
    Path getWedgePathForCenter(float x, float y)
    {
